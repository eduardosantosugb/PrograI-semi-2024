...
namespace academica {
    public partial class Form1 : Form {
        ...
        private void lblBuscarAlumnos_Click(object sender, EventArgs e)
        {
        ...
        private void grbEdicionAlumno_Enter(object sender, EventArgs e)
        {

        }

        private void grbNavegacionAlumno_Enter(object sender, EventArgs e)
        {
