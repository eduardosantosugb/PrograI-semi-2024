...
namespace academica {
    internal class Conexion {
        ...
        public DataSet obtenerDatos() {
            ...
            misComandos.CommandText = "SELECT * FROM frm_usuario";
        ...
        public String administrarUsuario(String[] datos)
        {
            ...
            if (datos[0] == "nuevo")
            {
                sql = "INSERT INTO Usuario(IdUsuario, usuario, clave, nombre, direccion, telefono) VALUES('" +
                    datos[2] + "','" + datos[3] + "','" + datos[4] + "','" + datos[5] + "','" + datos[6] + "','" + datos[7] + "'";
            }
            else if (datos[0] == "modificar")
            {
                sql = "UPDATE Usuario SET IdUsuario='" + datos[2] + "', nombre='" + datos[3] + "', direccion='" + datos[4] + "', telefono='" +
                    datos[5] + "', dui='" + datos[6] + "', gmail='" + datos[7] + "', especialidad='" + datos[8] + "' WHERE IdDocente=" + datos[1];
            }
            else if (datos[0] == "eliminar")
            {
